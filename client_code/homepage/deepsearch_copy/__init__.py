from ._anvil_designer import deepsearch_copyTemplate
from anvil import *
...
class deepsearch_copy(deepsearch_copyTemplate):
  ...
  def llenaListas(self, rowClases, rowCbienes, rowEstado, emp_rows):
    ...
    self.dd_clasesBienes.items = [
      (r["descripcion"], r["id"].strip()) for r in rowCbienes
    ]
